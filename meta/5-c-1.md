...
<br><br> Select the following link to download this indicator data in an accessible format:<br>[5.c.1 Proportion of countries with systems to track and make public allocations for gender equality and women’s empowerment (CSV 0.05 kB)](https://sustainabledevelopment-uk.github.io/sdg-data/data/5-c-1.csv)
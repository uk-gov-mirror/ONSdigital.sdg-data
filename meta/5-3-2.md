...
---
Select the following link to download this indicator data in an accessible format:<br><a href="{{ page.remote_data_prefix }}/data/{{ page.indicator.slug }}.csv">{{ page.indicator.number }}: {{ page.indicator.name }}</a>
